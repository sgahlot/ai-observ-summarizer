...
4. **Container images**: Builds and pushes images to `quay.io/ecosystem-appeng/{IMAGE_PREFIX}-{component}:{version}` (e.g., `quay.io/ecosystem-appeng/aiobs-react-ui:1.2.3`)
...
- `quay.io/ecosystem-appeng/aiobs-console-plugin:1.2.3`
- `quay.io/ecosystem-appeng/aiobs-react-ui:1.2.3`
